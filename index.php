...
$db = [
  ...
  [
    ...
    "risposta" => "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account."
  ],
  [
...
<body>
    <h1 class="title-page">Domande frequenti</h1>
